Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/Budweiser/twitter-kit-ios"
  s.documentation_url = "https://github.com/Budweiser/twitter-kit-ios/wiki"
  s.social_media_url = "https://taoren.me"
  s.authors = "Tao Ren"
  s.platform = :ios, "11.0"
  s.source = { :http => "https://github.com/Budweiser/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
